...
Full product spec: [`docs/spec.md`](docs/spec.md). Product principles (what we will
...
access is over a Tailscale tailnet (or `localhost` for dev). See `docs/spec.md` §6 for
